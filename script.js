...
//variable to generate a new password when button is clicked
var newPassword;
...
function generatePassword() {
  ...
  passLength = Number(passLength);
    ...
    if (passLength >= 8 && passLength <= 128) {
      ...
      //booleans for each type of required/recommended characters
...
// added loop that chooses a random character and repeats the process until the desried password length is met
